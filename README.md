...
Otech MFB Admin Dashboard
This is the admin dashboard for Otech Plus, the scan-to-pay platform built on Otech MFB’s infrastructure. It provides tools for managing merchants, payments, and user activities within Otech Plus.
...
The project is deployed on vercel which is next js client official hosting client:
