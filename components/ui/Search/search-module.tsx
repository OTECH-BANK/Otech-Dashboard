...
export const SearchModule: React.FC<SearchModuleProps> = ({
  ...
  return (
    <div
      className={`flex h-[37px] w-[380px] items-center justify-between gap-3 rounded-md border px-3 py-1 text-[#707070] transition-all duration-200 focus-within:ring-2 focus-within:ring-[#d97528] focus-within:ring-offset-2 hover:border-[#d97528] ${className}`}
    >
