...
import TransactionDetailModal, { Order } from "components/ui/Modal/transaction-detail-modal"
...
const ActionDropdown: React.FC<ActionDropdownProps> = ({ order, onViewDetails }) => {
